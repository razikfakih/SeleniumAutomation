...
String error;
	...
	//Scenario 1 Cond No. 5 About Your Car page with no selection for looking for cover field (Negative Test)
	@Test
	...
	if(!driver.findElements(By.xpath(".//h2[contains(text(),'Find your car')]")).isEmpty())
	    ...
	    driver.findElement(By.xpath(".//span[contains(text(),'Only')]/../..")).click();
	    ...
	    error = driver.findElement(By.xpath(".//span[contains(text(),'option')]")).getText();
	    
	    System.out.println("User prompted by message: " + error);
